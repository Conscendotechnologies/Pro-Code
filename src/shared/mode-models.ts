 ...
 *
 * `displayName` holds the model's name only. The "Recommended" suffix is
 * per-mode presentation and comes from MODE_RECOMMENDED_MODEL below.
 */
const MODELS: ModeModelInfo[] = [
	...
	{ modelId: "minimax/minimax-m2.5", displayName: "MiniMax: MiniMax M2.5", provider: "openrouter", tier: "Medium" },
	{
	...
	{ modelId: "xiaomi/mimo-v2-pro", displayName: "Xiaomi: MiMo-V2-Pro", provider: "openrouter", tier: "Advanced" },
	{
...
/**
 * The model each mode recommends. Modes offer the same list but point at
 * different defaults, so this is presentation rather than availability.
 */
const MODE_RECOMMENDED_MODEL: Record<string, string> = {
	"salesforce-agent": "z-ai/glm-4.5-air:free",
